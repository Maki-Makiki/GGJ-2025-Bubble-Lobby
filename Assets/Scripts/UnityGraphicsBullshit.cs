...
public static class UnityGraphicsBullshit
{
    ...
    private static FieldInfo MSAA_FieldInfo;
    ...
    static UnityGraphicsBullshit()
    {
        ...
        MSAA_FieldInfo = pipelineAssetType.GetField("m_MSAA", flags);
        //m_MSAA
    }
    ...
    public static MsaaQuality MSAA_Quality
    {
        get => (MsaaQuality)MSAA_FieldInfo.GetValue(GraphicsSettings.currentRenderPipeline);
        set => MSAA_FieldInfo.SetValue(GraphicsSettings.currentRenderPipeline, value);
    }
}